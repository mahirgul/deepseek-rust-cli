...
impl CodeColorizer {
    ...
    fn try_keyword(chars: &[char], i: usize, len: usize, lang: CodeLang) -> Option<usize> {
        // Build a slice of remaining chars
        let remaining: String = chars[i..].iter().collect();
        ...
        let keywords: &[&str] = match lang {
            CodeLang::Rust => &[
                ...
                "false", "for", "if", "in", "loop", "match", "move", "priv", "ref", "return",
                "self", "Self", "static", "super", "type", "unsafe", "where", "while", "yield",
                "Ok", "Err", "Some", "None",
            ],
            CodeLang::Python => &[
                "def", "class", "import", "from", "as", "return", "if", "elif", "else", "for",
                "while", "in", "not", "and", "or", "is", "with", "try", "except", "finally",
                "raise", "pass", "break", "continue", "yield", "lambda", "async", "await", "del",
                "global", "nonlocal", "assert", "print",
            ],
            ...
            CodeLang::Shell => &[
                ...
                "eval", "exec", "exit", "source", "echo", "cd", "ls", "cat", "grep", "sed", "awk",
            ],
            CodeLang::Sql => &[
                ...
                "END", "select", "from", "where", "insert", "update", "delete", "create", "drop",
                "alter", "table", "index", "view", "into", "values", "set", "join", "left",
                "right", "inner", "outer", "on", "as", "and", "or", "not", "null", "is", "in",
                "like", "between", "order", "by", "group", "having", "limit", "offset", "union",
                "all", "distinct", "count", "sum", "avg", "min", "max", "exists", "case", "when",
                "then", "end",
            ],
            CodeLang::Html => &[
